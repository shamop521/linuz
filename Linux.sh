...
function Start() {
  ...
  SYSMIRROR33='http://disk.29296819.xyz/d/dd/os/laosiji/WinSrv2003/10G/Pwd@Linux-C10G.vhd.gz'
  ...
  echo "  26) Windows 7 x86 Lite [X86-Legacy-Pwd@Linux]"
  echo "  27) Windows 7 x86 Lite [X86-Legacy-aliyun-Pwd@Linux]"
  echo "  28) Windows 7 x64 Lite [X64-Legacy-Pwd@Linux]"
  echo "  29) Windows 7 x64 Lite [X64-UEFI-Pwd@Linux]"
  echo "  30) Windows 10 LTSC Lite [X64-Legacy-Pwd@Linux]"
  echo "  31) Windows 10 LTSC Lite [X64-Legacy-aliyun-Pwd@Linux]"
  echo "  32) Windows 10 LTSC Lite [X64-UEFI-Pwd@Linux]"
  echo "  33) Windows Server 2003 Lite [X86-Legacy-Pwd@Linux]"
  echo "  34) Windows Server 2008 Lite [X64-Legacy-Pwd@Linux]"
  echo "  35) Windows Server 2008 Lite [X64-UEFI-Pwd@Linux]"
  echo "  36) Windows Server 2012 Lite [X64-Legacy-Pwd@Linux]"
  echo "  37) Windows Server 2012 Lite [X64-UEFI-Pwd@Linux]"
  echo "  38) Windows Server 2016 Lite [X64-Legacy-Pwd@Linux]"
  echo "  39) Windows Server 2016 Lite [X64-UEFI-Pwd@Linux]"
  echo "  40) Windows Server 2022 Lite [X64-Legacy-Pwd@Linux]"
  echo "  41) Windows Server 2022 Lite [X64-UEFI-Pwd@Linux]"
  ...
  case $N in
    ...
    9) 
	 ...
	 echo -e "Password length limit 8-16 bits. eg: Pwd@Linux\n"
